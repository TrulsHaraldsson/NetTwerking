...
func TestFindNode(t *testing.T) {
	d7024e.StartNode(8100, "none", "none")
	n1 := d7024e.StartNode(8101, "localhost:8100", "none")
	d7024e.StartNode(8102, "localhost:8100", "none")
	d7024e.StartNode(8103, "localhost:8102", "2111111400000000000000000000000000000000")
